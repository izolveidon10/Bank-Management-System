...
{   int choice,test=0;
    ...
    while (fscanf(old,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&add.acc_no,add.name,&add.dob.month,&add.dob.day,&add.dob.year,&add.age,add.address,add.citizenship,&add.phone,add.acc_type,&add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
   {
            ...
            {   test=1;
                ...
                {
                    printf("\a\a\a\n\nYOU CANNOT DEPOSIT MONEY IN FIXED ACCOUNTS!!!!!");
                    fordelay(1000000000);
                    system("cls");
                    menu();
...
{   int choice,test=0;
    ...
    while (fscanf(old,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&add.acc_no,add.name,&add.dob.month,&add.dob.day,&add.dob.year,&add.age,add.address,add.citizenship,&add.phone,add.acc_type,&add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
   {
            ...
            {   test=1;
                if(strcmpi(add.acc_type,"fixed1")==0||strcmpi(add.acc_type,"fixed2")==0||strcmpi(add.acc_type,"fixed3")==0)
                {
                    printf("\a\a\a\n\nYOU CANNOT WITHDRAW MONEY IN FIXED ACCOUNTS!!!!!");
                    fordelay(1000000000);
                    system("cls");
                    menu();
                ...
                if(strcmpi(add.acc_type,"fixed1")==0)
                    {
                        ...
                        printf("\n\nYou will get TK%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+1);
                    }
                else if(strcmpi(add.acc_type,"fixed2")==0)
                    {
                        ...
                        rate=11;
                        intrst=interest(time,add.amt,rate);
                        printf("\n\nYou will get TK.%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+2);
                ...
                else if(strcmpi(add.acc_type,"fixed3")==0)
                    {
                        ...
                        rate=13;
                        intrst=interest(time,add.amt,rate);
                        printf("\n\nYou will get TK.%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+3);
                 ...
                 else if(strcmpi(add.acc_type,"saving")==0)
                    {
                        ...
                        rate=8;
                        intrst=interest(time,add.amt,rate);
                        printf("\n\nYou will get TK.%.2f as interest on %d of every month",intrst,add.deposit.day);
